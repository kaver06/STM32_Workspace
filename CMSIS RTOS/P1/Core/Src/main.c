...
int main(void)
{
  ...
  /* creation of oddSem */
  oddSemHandle = osSemaphoreNew(1, 0, &oddSem_attributes);

  /* creation of evenSem */
  evenSemHandle = osSemaphoreNew(1, 1, &evenSem_attributes);
